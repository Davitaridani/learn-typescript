...
function printReturnType(param: string): string {
  return param
}
...
function printVoid(param: string): void {
  console.log(param)
}
...
// Function parameter
function printFunctParams(param1: string | number | boolean, params2?:string | number) : void {
...
function funtDefaultParams(param1: string, params2: string = "Ini Nilai default params") : string {
...
function funcOverloading (param1: string, param2: string): string 
function funcOverloading (param1: number, param2: number): number 
function funcOverloading (param1: any, param2: any): any {
